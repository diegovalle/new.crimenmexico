...
crosslet.defaultDimensionConfig = {
  ...
  render: {
    ...
    rangeForm: function(d, el) {
      ...
      html = "Rango: <input type='text' name='m0' size='" + size + "' value='" + d.format.input(d)(d.filter[0]) + "'> &ndash; <input type='text' name='m1' size='3' value='" + d.format.input(d)(d.filter[1]) + "'>";
      return el.html(html);
    }
  },
...
//Changed to use toner tiles
    ...
    L.tileLayer('https://maps.wikimedia.org/osm-intl/{z}/{x}/{y}.png', this.config.map.leaflet).addTo(this.map);
