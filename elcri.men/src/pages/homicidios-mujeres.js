...
import social_image
  from '../assets/images/social/social-homicidios-mujeres.png';
import social_image_en
  from '../assets/images/social/social-homicidios-mujeres_en.png';
  ...
  useEffect (() => {
    ...
    fetch ('/elcrimen-json/states_females_total.json')
      ...
      .then (responseJSON => {
        ...
        responseJSON[1] = MG.convert.date (responseJSON[1], 'date');
